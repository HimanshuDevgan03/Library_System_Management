...
VALUES('RS126', 'IS135', CURRENT_DATE, 'Good');
...
SELECT
    ...
    -- 1) Number of overdue books
    SUM(
        CASE
            WHEN i.issued_date < CURRENT_DATE - INTERVAL '30 days'
    ...
    -- 2) Total fines = $0.50 for each overdue day past 30
    SUM(
        CASE
            WHEN i.issued_date < CURRENT_DATE - INTERVAL '30 days'
             AND r.return_id IS NULL
    ...
    -- 3) Total books ever issued by the member
